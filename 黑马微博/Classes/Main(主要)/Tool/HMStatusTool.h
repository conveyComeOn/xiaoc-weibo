...
+ (void)commentWithPara:(KWCommentParam *)param success:(void (^)(KWCommentResult *result))success failure:(void (^)(NSError *error))failure;

+ (void)responsetWithParam:(KWResponseParam *)param success:(void (^)(KWResponseReault *result))success failure:(void (^)(NSError *error))failure;
