...
- (void)addAllChildVcs
{
    ...
    [self addOneChlildVc:home title:@"葱叶" imageName:@"tabbar_home" selectedImageName:@"tabbar_home_selected"];
    self.home = home;
    self.lastSelectedViewContoller = home;
    
    HMMessageViewController *message = [[HMMessageViewController alloc] init];
    [self addOneChlildVc:message title:@"葱信" imageName:@"tabbar_message_center" selectedImageName:@"tabbar_message_center_selected"];
    self.message = message;
    
    HMDiscoverViewController *discover = [[HMDiscoverViewController alloc] init];
    [self addOneChlildVc:discover title:@"葱花" imageName:@"tabbar_discover" selectedImageName:@"tabbar_discover_selected"];
